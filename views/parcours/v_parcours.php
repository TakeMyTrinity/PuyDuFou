...
<body>
    <div class="background-image-container">
        <img class="background-image"
            src="https://prod-sites-pdf-webdata.s3.eu-west-1.amazonaws.com/france/files/s3fs-public/styles/home_main_image_desktop/public/homepage/main-image/visuel_page_accueil_pdf_france_v2.jpg.webp?VersionId=BBtO6ybCZMQZal0uHTQ5oGfZIOrBYjRK&itok=WvkI1sqi"
            alt="Visuel Vikings Puy Du Fou 2023">
    </div>
                ...
                <div class="card-header" id="heading<?php echo $parcours['Id_Parcours']; ?>">
                    <h5 class="mb-0">
                        <button class="btn btn-link" type="button" data-toggle="collapse"
                            data-target="#collapse<?php echo $parcours['Id_Parcours']; ?>" aria-expanded="true"
                            aria-controls="collapse<?php echo $parcours['Id_Parcours']; ?>">
                            Parcours <?php echo $parcours['Id_Parcours']; ?>
                        </button>
                    </h5>
                </div>

                <div id="collapse<?php echo $parcours['Id_Parcours']; ?>" class="collapse"
                    aria-labelledby="heading<?php echo $parcours['Id_Parcours']; ?>" data-parent="#accordion">
                    <div class="card-body">
