...
<section class="Form my-4 mx-5">
    <div class="container">
        <div class="row no-gutters">
            <div class="col-lg-5">
                <img src="http://localhost/PuyDuFou/utils/images/connection.webp" class="img-fluid">
            </div>
            <div class="col-lg-7 px-5 pt-5">
                ...
                <form action="index.php?uc=connection&action=confirmInscription" method="post">
                    <div class="form-row">
                        ...
                        <div class="col-lg-7">
                            <input type="text" name="nomS" placeholder="Nom" class="form-control my-3 p-4" required>
                            <input type="text" name="prenomS" placeholder="Prénom" class="form-control my-3 p-4"
                                required>
                        </div>

                        <div class="col-lg-7">
                            <input type="mail" name="mailS" placeholder="Adresse Mail" class="form-control my-3 p-4"
                                required>
                    ...
                    <p>tu veux revenir à l'accueil ?<a href="index.php">Clique ici
                            :</a></p>
                    <p>Tu es déjà un visiteur ?<a href="index.php?uc=connection&action=seConnecter">Connecte toi ici
                            :</a>
                    </p>
                </form>
            </div>
