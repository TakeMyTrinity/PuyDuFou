...
<section class="Form my-4 mx-5">
    <div class="container">
        <div class="row no-gutters">
            <div class="col-lg-5">
                <img src="http://localhost/PuyDuFou/utils/images/connection.webp" class="img-fluid" srcset="">
            </div>
            <div class="col-lg-7 px-5 pt-5">
                ...
                <form action="index.php?uc=connection&action=confirmConnection" method="post">
                    <div class="form-row">
                        <div class="col-lg-7">
                            <input type="mail" name="username" placeholder="Adresse Mail" class="form-control my-3 p-4"
                                required>
                        </div>
                    </div>
                    <div class="form-row">
                    ...
                    <p>Tu n'as pas de compte ? <a href="index.php?uc=connection&action=inscription">Inscrit toi ici
                            :</a>
                    </p>
                </form>
            </div>
